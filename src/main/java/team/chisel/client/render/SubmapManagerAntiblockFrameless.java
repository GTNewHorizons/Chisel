...
public class SubmapManagerAntiblockFrameless extends SubmapManagerBase {
    ...
    public void registerIcons(String modName, Block block, IIconRegister register) {
        submap = new TextureSubmap(
            register.registerIcon(modName + ":antiblockFrameless/" + color + "-antiBlockFrameless-ctm"),
            4,
            4);
        submapSmall = new TextureSubmap(
            register.registerIcon(modName + ":antiblockFrameless/" + color + "-antiBlockFrameless"),
            2,
            2);
    }
